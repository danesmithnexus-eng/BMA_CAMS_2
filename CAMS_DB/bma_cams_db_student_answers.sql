...
CREATE TABLE `student_answers` (
  ...
  PRIMARY KEY (`id`),
  KEY `student_answers_assignment_id_foreign` (`assignment_id`),
  KEY `student_answers_question_id_foreign` (`question_id`),
  CONSTRAINT `student_answers_assignment_id_foreign` FOREIGN KEY (`assignment_id`) REFERENCES `student_exam_assignments` (`id`) ON DELETE CASCADE,
